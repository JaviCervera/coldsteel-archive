...
namespace irr
{
	...
	*/
	...
	public:
		...
		IReferenceCounted()
			// JEDIVE:
			: ReferenceCounter(1), DebugName(0), UserData(NULL) //, userDataDeleteCallback(NULL)
		{
		}
		...
		// JEDIVE:
		// User data pointer and callback function called on cleanup. Every IrrLicht object can have generic user data
		void* UserData;
		//void (*userDataDeleteCallback)(void*);
		...
		bool drop() const
		{
			...
			{
				// JEDIVE:
				//if (userDataDeleteCallback != NULL)
				//	userDataDeleteCallback((void*) this);
				delete this;
				return true;
			}
