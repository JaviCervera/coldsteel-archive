...
public:
	...
	// JEDIVE:
  virtual s32 addEffectMaterial(const c8* effect,
    IEffectCallBack* callback = 0,
    E_MATERIAL_TYPE baseMaterial = video::EMT_SOLID,
    s32 userData = 0) = 0;

  virtual s32 addEffectMaterialFromFile(io::IReadFile* effectFile,
    IEffectCallBack* callback = 0,
    E_MATERIAL_TYPE baseMaterial = video::EMT_SOLID,
    s32 userData = 0) = 0;

  virtual s32 addEffectMaterialFromFile(const c8* effectFile,
    IEffectCallBack* callback = 0,
    E_MATERIAL_TYPE baseMaterial = video::EMT_SOLID,
    s32 userData = 0) = 0;
};
